...
func TestAPIv1NotFound(t *testing.T) {
	srv, _ := testServer(t)
	resp, err := http.Get(srv.URL + "/api/v0/subjects/99999")
	if err != nil {
		t.Fatalf("GET: %v", err)
	}
...
func TestTagsEmpty(t *testing.T) {
	srv, _ := testServer(t)
	resp, err := http.Get(srv.URL + "/api/v0/tags")
	if err != nil {
		t.Fatalf("GET: %v", err)
	}
...
func TestTrackerListEmpty(t *testing.T) {
	srv, _ := testServer(t)
	resp, err := http.Get(srv.URL + "/api/v0/tracker")
	if err != nil {
		t.Fatalf("GET: %v", err)
	}
	if resp.StatusCode != http.StatusOK {
...
func TestOpenAPIYaml(t *testing.T) {
	...
	resp, err := http.Get(srv.URL + "/api/v0/openapi.yaml")
	if err != nil {
		t.Fatalf("GET: %v", err)
	}
...
func TestCORS(t *testing.T) {
	srv, _ := testServer(t)
	req, _ := http.NewRequest("OPTIONS", srv.URL+"/api/v0/subjects", nil)
...
func TestTrackerCreate(t *testing.T) {
	...
	resp, err := http.Post(srv.URL+"/api/v0/tracker/create", "application/json",
