...
func TestELOPairNeedsTwoSubjects(t *testing.T) {
	srv, _ := testServer(t)
	resp, _ := http.Get(srv.URL + "/api/v0/elo/pair")
...
func TestELOCompare(t *testing.T) {
	srv, _ := testServer(t)
	resp, err := http.Post(srv.URL+"/api/v0/elo/compare", "application/json",
...
func TestELOCompareMissingParams(t *testing.T) {
	srv, _ := testServer(t)
	resp, _ := http.Post(srv.URL+"/api/v0/elo/compare", "application/json",
